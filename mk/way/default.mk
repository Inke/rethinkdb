...
# TODO: if the need for some of these flags can be detected, they should be set by the configure script

# Configuration file generated by ./configure (as a path relative to the configure script)
CONFIG ?= config.mk
...
# Set to 1 to always use the internal version of the toolchain
